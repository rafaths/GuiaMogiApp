    ...
    Rate.prototype.setValue = function(value)
    {
        if (!this.settings.readonly)
        {
            ...
            $(this.element).attr("data-rate-value", this.value);
				...
				// pega o valor das estrelas ao clicar nelas
				var atendimento = $("#atendimento").attr("data-rate-value");							
				var divatendimento = atendimento;
				$("#valoratendimento").html(divatendimento);
				
				var preco = $("#preco").attr("data-rate-value");						
				var divpreco = preco;
				$("#valorpreco").html(divpreco);

                var qualidade = $("#qualidade").attr("data-rate-value");               
                var divqualidade = qualidade;
                $("#valorqualidade").html(divqualidade);            
